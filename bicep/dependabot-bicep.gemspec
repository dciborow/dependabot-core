...
Gem::Specification.new do |spec|
  ...
  spec.name         = "dependabot-bicep"
  spec.summary      = "Provides Dependabot support for Bicep"
  spec.description  = "Dependabot-Bicep provides support for bumping Bicep modules via Dependabot. " \
