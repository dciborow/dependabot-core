...
require "dependabot/bicep/requirements_updater"
  ...
  module Bicep
    class UpdateChecker < Dependabot::UpdateCheckers::Base
      ...
      def latest_resolvable_version
        # No concept of resolvability for bicep modules (that we're aware
        # of - there may be in future).
        latest_version
      end

      def latest_resolvable_version_with_no_unlock
        # Irrelevant, since Bicep doesn't have a lockfile
        nil
      end
      ...
      def latest_version_resolvable_with_full_unlock?
        # Full unlock checks aren't relevant for Bicep files
        false
      end
...
Dependabot::UpdateCheckers.
  register("bicep", Dependabot::Bicep::UpdateChecker)
